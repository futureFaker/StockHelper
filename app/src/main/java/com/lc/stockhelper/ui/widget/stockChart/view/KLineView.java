package com.lc.stockhelper.ui.widget.stockChart.view;
...
import com.lc.stockhelper.ui.widget.stockChart.BarBottomMarkerView;
import com.lc.stockhelper.ui.widget.stockChart.CandleCombinedChart;
import com.lc.stockhelper.ui.widget.stockChart.CoupleChartGestureListener;
import com.lc.stockhelper.ui.widget.stockChart.KRightMarkerView;
import com.lc.stockhelper.ui.widget.stockChart.LeftMarkerView;
import com.lc.stockhelper.ui.widget.stockChart.MyCombinedChart;
import com.lc.stockhelper.ui.widget.stockChart.data.KLineDataManage;
import com.lc.stockhelper.ui.widget.stockChart.enums.TimeType;
...
public class KLineView extends BaseView {
    ...
    public KLineView(Context context, @Nullable AttributeSet attrs) {
        ...
        zbColor = new int[]{ContextCompat.getColor(context, R.color.ma5),
                ContextCompat.getColor(context, R.color.ma10),
                ContextCompat.getColor(context, R.color.up_color),
                ContextCompat.getColor(context, R.color.up_color),
                ContextCompat.getColor(context, R.color.up_color),
                ContextCompat.getColor(context, R.color.up_color),
                ContextCompat.getColor(context, R.color.up_color),
    ...
    public void setDataToChart(KLineDataManage data) {
        ...
        barChartData.setData(new LineData(kLineData.getLineDataVolume()));
    ...
    public void updateText(int index, boolean isSelect) {
        ...
        KLineDataModel kLineDataModel = kLineData.getKLineDatas().get(index);
        ...
        candleChart.setDescriptionCustom(zbColor,
                new String[]{
                        "MA5:" + NumberUtils.keepPrecision(kLineDataModel.getMa5(), 3),
                        "MA10:" + NumberUtils.keepPrecision(kLineDataModel.getMa10(), 3),
                        "开盘价:" + NumberUtils.keepPrecision(kLineDataModel.getOpen(), 3),
                        "收盘价:" + NumberUtils.keepPrecision(kLineDataModel.getClose(), 3),
                        "最高价:" + NumberUtils.keepPrecision(kLineDataModel.getHigh(), 3),
                        "最低价:" + NumberUtils.keepPrecision(kLineDataModel.getLow(), 3),
                        "涨幅:" + NumberUtils.keepPrecision(kLineDataModel.getGain(), 3),
                        "成交量" + NumberUtils.formatVol(mContext,kLineData.getAssetId(),kLineDataModel.getVolume()),
                        "换手率:" + NumberUtils.keepPrecision(kLineDataModel.getHandTurnover(), 3)
                });
        chartSwitch(index);
    }
