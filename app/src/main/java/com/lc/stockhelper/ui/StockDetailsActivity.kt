    ...
    private fun getStockDetails(){
        launch {
            ...
            if(!dayData.isEmpty()){
                ...
                val clickLisener = View.OnClickListener {
                    val intent = Intent(this@StockDetailsActivity, StockDetailsLandActivity::class.java)
                ...
                val fragments = arrayOf<Fragment>(
                    ChartKLineFragment.newInstance(ChartKLineFragment.TYPE_DAY,dayData,false).apply {
                        onClickListener = clickLisener
                    },
                    ChartKLineFragment.newInstance(ChartKLineFragment.TYPE_WEEK,weekData, false).apply {
                        onClickListener = clickLisener
                    }
