...
import com.lc.stockhelper.ui.widget.stockChart.model.KLineDataModel;
import com.lc.stockhelper.ui.widget.stockChart.model.bean.BOLLEntity;
import com.lc.stockhelper.ui.widget.stockChart.model.bean.KDJEntity;
import com.lc.stockhelper.ui.widget.stockChart.model.bean.MACDEntity;
import com.lc.stockhelper.ui.widget.stockChart.model.bean.RSIEntity;
...
public class KLineDataManage {
     ...
     * 解析K线数据
     */
    public void parseKlineData(ArrayList<StockDetail> datas, String assetId, boolean landscape) {
        ...
        if (datas != null) {
            ...
            if (datas.size() > 10) {
                ...
                for (int i = 0; i < len - 10; i++) {
                    ...
                    klineDatamodel.setDateMills(stockDetail.getDate());
                    klineDatamodel.setOpen(stockDetail.getOpen());
                    klineDatamodel.setClose(stockDetail.getClose());
                    klineDatamodel.setHigh(stockDetail.getHigh());
                    klineDatamodel.setLow(stockDetail.getLow());
                    klineDatamodel.setGain(stockDetail.getZdf());
                    klineDatamodel.setHandTurnover(stockDetail.getHsl());
                    klineDatamodel.setTotal(stockDetail.getCje());
                    klineDatamodel.setVolume(stockDetail.getCjl());

                    double ma5 = (
                            stockDetail.getClose()
                            + datas.get(index+1).getClose()
                            + datas.get(index+2).getClose()
                            + datas.get(index+3).getClose()
                            + datas.get(index+4).getClose()) / 5.0;

                    klineDatamodel.setMa5(ma5);

                    double ma10 = (stockDetail.getClose()
                            + datas.get(index+1).getClose()
                            + datas.get(index+2).getClose()
                            + datas.get(index+3).getClose()
                            + datas.get(index+4).getClose()
                            + datas.get(index+5).getClose()
                            + datas.get(index+6).getClose()
                            + datas.get(index+7).getClose()
                            + datas.get(index+8).getClose()
                            + datas.get(index+9).getClose()) / 10.0;

                    klineDatamodel.setMa10(ma10);
                    klineDatamodel.setMa20(0);
                    klineDatamodel.setPreClose(datas.get(index+1).getClose());

                    double volume5 = (stockDetail.getCjl()
                            + datas.get(index+1).getCjl()
                            + datas.get(index+2).getCjl()
                            + datas.get(index+3).getCjl()
                            + datas.get(index+4).getCjl()) / 5.0;


                    double volume10 = (stockDetail.getCjl()
                            + datas.get(index+1).getCjl()
                            + datas.get(index+2).getCjl()
                            + datas.get(index+3).getCjl()
                            + datas.get(index+4).getCjl()
                            + datas.get(index+5).getCjl()
                            + datas.get(index+6).getCjl()
                            + datas.get(index+7).getCjl()
                            + datas.get(index+8).getCjl()
                            + datas.get(index+9).getCjl()) / 10.0;
